...
namespace TheCoreBanking.Customer.Data.Helpers
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// </summary>
        public TheCoreBankingCustomerContext DbContext { get; set; }
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<TheCoreBankingCustomerContext, object> factory = null) where T : class
        {
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<TheCoreBankingCustomerContext, object> factory, TheCoreBankingCustomerContext dbContext)
        {
