...
var departments, postData = {}, productData = {}, approvalData = {}, updateAccount, iscurrentaccount = false;
...
function initDataTable() {
    ...
    $.ajax("../Account/LoadProducts")
        .then(function (response) {
            ...
            $("#post-status-data-table")
                .bootstrapTable("refresh", {
                    url: "../Account/LoadAccounts"
                });

        });
    $.ajax("../Account/LoadAccountPostStatusesForDataTableFormatter")
        .then(function (response) {
           //debugger
            $.each(response, function (index, value) {
                postData[value.postnostatusid] = value.postnostatusname;
            });
            // Let data table load its data / refresh with url
...
//        ].join("");
//    },
    postNameFormatter: function (value) {
